...
public class gm extends HttpServlet {
	...
	public static String parjs(String s) {
		...
		if (qq3 != null) {
			...
			if (s3.indexOf("<a ") > -1) {
				s3 = "<table><tr><td width=280px>" + s3 + "</td></tr></table>";
	...
	public static String pars2(String s) {
		...
		if (s.trim().length() > 12) {
			...
			s = "<div><table><tr valign='top'><td valign='top'><a href=\"javascript: document.getElementById('myform"
					...
					+ im
					+ "</a></td><td>&nbsp;</td><td style='color:#444444;font-family: Arial;font-size:12px;'  valign='top'>"
					+ s_button + s + s_end + "</td></tr></table></div><hr/>";// s_button
																				// +
		} else
			s = "";
